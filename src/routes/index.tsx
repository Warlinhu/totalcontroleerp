...
const DOWNLOADS = [
  {
    ...
    size: "App x64",
    icon: Monitor,
    href: `${GH_RELEASE}/TotalControleERP-windows-x64.zip`,
    hint: "Baixe, extraia o .zip e abra TotalControleERP.exe.",
  },
  {
    id: "macos",
    label: "macOS",
    ...
    size: "Intel x64",
    icon: Apple,
    href: `${GH_RELEASE}/TotalControleERP-macos-x64.zip`,
    hint: "Baixe, extraia o .zip e mova o app para Aplicativos.",
  },
  {
    id: "linux",
    label: "Linux",
    ...
    size: "App x64",
    icon: Monitor,
    href: `${GH_RELEASE}/TotalControleERP-linux-x64.tar.gz`,
    hint: "Baixe, extraia o arquivo e execute TotalControleERP.",
  },
  {
    id: "android",
    label: "Android",
